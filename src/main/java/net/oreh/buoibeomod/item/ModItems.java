...
import net.oreh.buoibeomod.item.custom.DowsingRodItem;
...
public class ModItems {
	...
	public static final RegistryObject<Item> DOWNSINGROD = ITEMS.register("dowsing_rod",
			() -> new DowsingRodItem(new Item.Properties().tab(ModCreativeModTab.BUOIBEO_TAB).durability(100)));
